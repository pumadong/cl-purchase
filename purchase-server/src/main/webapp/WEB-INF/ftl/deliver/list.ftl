				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>发货单列表
							</div>						
						</div>
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									<button class="btn btn-add blue table-group-action-submit" id="DeliverForm-add" data-toggle="modal" onclick="javascript:BacktrackForm.add_click();"> 新增</button>
								</div>
...
<script src="${BasePath}/scripts/custom/base/deliverform.js"></script>
<script>
