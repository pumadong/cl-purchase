...
`supplier_type`  int(1) NOT NULL DEFAULT 0 COMMENT '合作方式：经销、代销、联营、包销、对方发货' ,
`settle_type`  int(1) NOT NULL DEFAULT 0 COMMENT '结算类型：' ,
...
`supplier_id`  int(4) UNSIGNED NOT NULL COMMENT '供应商ID' ,
`contract_type`  int(1) NOT NULL DEFAULT 0 COMMENT '合同类型：经销、代销、联营、包销、对方发货' ,
`validate_date_begin`  datetime NOT NULL COMMENT '生效开始日期' ,
`validate_date_end`  datetime NOT NULL COMMENT '生效结束日期' ,
`status`  int(1) NOT NULL DEFAULT 0 COMMENT '状态：-1已作废0待审核1已审核' ,
`create_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '记录生成人' ,
`create_date`  datetime NOT NULL COMMENT '记录生成时间' ,
`update_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '更新人' ,
`update_date`  datetime NOT NULL COMMENT '更新时间' ,
...
`status`  int(1) NOT NULL DEFAULT 0 COMMENT '状态：-1已作废0待确认1已确认2已完成' ,
...
`purchase_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '采购数量' ,
`storage_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '已入库数量' ,
`status`  int(4) NOT NULL DEFAULT 0 COMMENT '0未完成1已完成' ,
`purchase_price`  decimal(20,3) NOT NULL DEFAULT 0 COMMENT '采购价格' ,
`create_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '记录生成人' ,
`create_date`  datetime NOT NULL COMMENT '记录生成时间' ,
`update_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '更新人' ,
`update_date`  datetime NOT NULL COMMENT '更新时间' ,
...
`purchase_no` varchar(50) NOT NULL COMMENT '采购单号' ,
`warehouse_id` int NOT NULL COMMENT '收货仓库ID' ,
`status`  int(1) NOT NULL DEFAULT 0 COMMENT '状态：-1已作废0待确认1已确认2已完成' ,
...
`deliver_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '发货数量' ,
`storage_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '入库数量' ,
`storage_normal_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '入库正品数量' ,
`storage_broken_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '入库残品数量' ,
`purchase_price`  decimal(20,3) NOT NULL DEFAULT 0 COMMENT '采购价格' ,
`create_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '记录生成人' ,
`create_date`  datetime NOT NULL COMMENT '记录生成时间' ,
`update_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '更新人' ,
...
`status`  int(1) NOT NULL DEFAULT 0 COMMENT '状态：-1已作废0待确认1已确认2已完成' ,
`backtrack_type`  int(1) NOT NULL DEFAULT 0 COMMENT '返厂类型：采购返厂/库内返厂' ,
`commodity_type`  int(1) NOT NULL DEFAULT 0 COMMENT '商品类型：正品/残品' ,
`create_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '记录生成人' ,
`create_date`  datetime NOT NULL COMMENT '记录生成时间' ,
`update_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '更新人' ,
`update_date`  datetime NOT NULL COMMENT '更新时间' ,
...
`backtrack_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '计划返厂数量' ,
`storage_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '仓库确认数量' ,
`storage_normal_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '返厂正品数量' ,
`storage_broken_quality`  int(4) NOT NULL DEFAULT 0 COMMENT '返厂残品数量' ,
`backtrack_price`  decimal(20,3) NOT NULL DEFAULT 0 COMMENT '返厂价格' ,
`create_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '记录生成人' ,
`create_date`  datetime NOT NULL COMMENT '记录生成时间' ,
`update_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '更新人' ,
`update_date`  datetime NOT NULL COMMENT '更新时间' ,
